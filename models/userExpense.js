...
const UserExpense = {
    insertUserExpense: async (id_user, id_user_payment_method, id_category, expense_amount, expense_desc) => {
        const result = await pool.query(
            `INSERT INTO user_expense (id_user, id_user_payment_method, id_category, expense_amount, expense_desc)
             VALUES ($1, $2, $3, $4, $5) RETURNING id_user_expense`,
            [id_user, id_user_payment_method, id_category, expense_amount, expense_desc]
        );
